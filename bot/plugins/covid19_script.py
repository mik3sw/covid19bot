...
#print('== Report settimanale ==\nContagiati: {}\nMorti: {}\nGuariti: {}\nTamponi: {}'.format(c1, c2, c3, c4))
#c1, c2, c3, c4 = c.get_media_mensile()
#print('\n\n== Report mensile ==\nContagiati: {}\nMorti: {}\nGuariti: {}\nTamponi: {}'.format(c1, c2, c3, c4))

#print('\n\n== Incremento percentuale ==\nContagiati: {}%\nMorti: {}%\nGuariti: {}%\nTamponi: {}%\n'.format(c.incremento_p_contagiati, c.incremento_p_deceduti, c.incremento_p_guariti, c.incremento_p_tamponi))
#print(c.incremento_p_tamponi, c.incremento_p_guariti, c.incremento_p_deceduti, c.incremento_p_contagiati)